...
//extern void square_dgemm (double*, int, double*, double*, double*);
...
int main (int argc, char **argv)
{
  ...
  //double* bf = (double*)malloc( 65*sizeof(double)*nmax );
  /* For each test size */
...
//	memset (bf, 0, n * 65 * sizeof(double));
	
	for (n_iterations = 1; seconds < timeout; n_iterations *= 2) 
    {
      /* Warm-up */
		//square_dgemm ( bf, n, A, B, C);
